...
public class XmlParser {
	private static final String XML_DATA_PATH = "E:\\myEclipse\\projects\\MyDataDriver\\files\\oschina_web.xml";
	...
	public static Process parseXmlData() throws Exception{
		...
		process.setPackageName(root.attributeValue("url"));
		...
		while(iterator.hasNext()){
			...
			case "task":
				Task task = new Task();
				String key = element.attributeValue("url");
				task.setTaskClass(element.attributeValue("url"));
